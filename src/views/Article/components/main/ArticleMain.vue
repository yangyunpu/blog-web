...
import { getHomeArticleDetails, frontGetParentComment, articleLike, cancelArticleLike, addLike, cancelLike, getIsLikeByIdAndType } from '@/apis/article.js'
...
<template>
    <el-card class="card">
        ...
        <div class="tagLine">
            <el-text class="text">{{articleInfo.createdAt}}</el-text>
            <el-text class="icon"><i class="iconfont icon-browse"></i>{{articleInfo.view_times}}</el-text>
